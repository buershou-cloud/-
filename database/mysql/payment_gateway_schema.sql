...
CREATE TABLE IF NOT EXISTS pay_channel (
  ...
  douyin_gateway_url VARCHAR(255) NULL DEFAULT 'https://api.douyinpay.com' COMMENT '抖音支付网关',
...
CREATE TABLE IF NOT EXISTS pay_order (
  ...
  status VARCHAR(32) NOT NULL DEFAULT 'UNPAID' COMMENT 'UNPAID、COMPLETED、PARTIALLY_REFUNDED、REFUNDED、FROZEN、UNFROZEN、CLOSED',
