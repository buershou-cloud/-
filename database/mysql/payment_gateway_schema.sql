...
CREATE TABLE IF NOT EXISTS merchant (
  ...
  login_password_hash VARCHAR(255) NULL COMMENT '商户后台密码哈希，演示系统暂未启用',
  created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS pay_order (
  ...
  status VARCHAR(32) NOT NULL DEFAULT 'UNPAID' COMMENT 'UNPAID、COMPLETED、REFUNDED、FROZEN',
...
INSERT INTO pay_channel (
  ...
  app_id, alipay_public_key, merchant_private_key, sub_merchant_id, notify_url, return_url
) VALUES
  ('ali-main', 'ALIPAY', 1, 1, 10, 2, 0.01, 50000.00, '', NULL, NULL, NULL,
   'http://localhost:18081/api/v1/alipay/notify/ali-main', 'http://localhost:18081/payments/return'),
  ('ali-backup', 'ALIPAY', 0, 1, 20, 1, 0.01, 10000.00, '', NULL, NULL, NULL,
   'http://localhost:18081/api/v1/alipay/notify/ali-backup', NULL),
  ('ali-direct', 'ALIPAY_DIRECT', 0, 1, 30, 1, 0.01, 50000.00, '', NULL, NULL, '',
   'http://localhost:18081/api/v1/alipay/notify/ali-direct', 'http://localhost:18081/payments/return')
...
INSERT IGNORE INTO pay_channel_product (channel_id, product) VALUES
  ('ali-main', 'ALIPAY_WAP'),
  ('ali-main', 'ALIPAY_F2F'),
  ('ali-main', 'ALIPAY_PREAUTH'),
  ('ali-main', 'ALIPAY_PAGE'),
  ('ali-main', 'ALIPAY_ORDER_CODE'),
  ('ali-main', 'ALIPAY_JSAPI'),
  ('ali-backup', 'ALIPAY_WAP'),
  ('ali-backup', 'ALIPAY_F2F'),
  ('ali-backup', 'ALIPAY_PAGE'),
  ('ali-backup', 'ALIPAY_ORDER_CODE'),
  ('ali-backup', 'ALIPAY_JSAPI'),
  ('ali-direct', 'ALIPAY_DIRECT'),
  ('ali-direct', 'ALIPAY_DIRECT_WAP'),
  ('ali-direct', 'ALIPAY_DIRECT_F2F'),
  ('ali-direct', 'ALIPAY_DIRECT_PAGE'),
  ('ali-direct', 'ALIPAY_DIRECT_ORDER_CODE'),
  ('ali-direct', 'ALIPAY_DIRECT_JSAPI');
...
INSERT INTO merchant (
  ...
  ('M10001', '示例商户A', 0.6000, '正常', '待结算', 'MD5_DEMO_M10001_CHANGE_ME', NULL, NULL, NULL, 'MD5_RSA2', 'ROUND_ROBIN'),
  ('M10002', '示例商户B', 0.5500, '正常', '待结算', 'MD5_DEMO_M10002_CHANGE_ME', NULL, NULL, NULL, 'MD5_RSA2', 'ROUND_ROBIN'),
  ('M10003', '示例商户C', 0.6500, '待审核', '待结算', 'MD5_DEMO_M10003_CHANGE_ME', NULL, NULL, NULL, 'MD5_RSA2', 'ROUND_ROBIN')
ON DUPLICATE KEY UPDATE
  name = VALUES(name),
...
INSERT IGNORE INTO merchant_channel (merchant_id, channel_id) VALUES
  ('M10001', 'ali-main'),
  ('M10002', 'ali-main'),
  ('M10002', 'ali-backup'),
  ('M10003', 'ali-direct');
